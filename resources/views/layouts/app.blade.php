...
<head>
    ...
    <title>Praktik Pemrograman Backend | Class Penduduk - @yield('title') </title>
...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="{{URL('./dist/img/logo-white.png')}}" alt="logo" height="60" width="60">
        </div>
        <!-- Navbar -->
